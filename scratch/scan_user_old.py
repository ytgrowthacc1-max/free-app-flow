...
cmd = "npx wrangler d1 execute 6839fec9-ebad-41e9-829f-f618f21ce184 --remote --command=\"SELECT name, sql FROM sqlite_schema WHERE type='table';\" --json"
...
print("Tables referencing User_old:")
found = False
for t in tables:
    name = t.get("name")
    sql = t.get("sql") or ""
